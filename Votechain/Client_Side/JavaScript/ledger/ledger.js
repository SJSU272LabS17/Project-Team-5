		...
		success: function(d) {
			...
			for(var i = d.transactions.length-1; i >= 0 ; i--)
			{
				...
				if(obj.payload.indexOf("create_vehicle_log") == -1)
				{
					...
					if(type == "Transfer")
					{	//272
						var vin = get_update("VID", v5cID);
						var make = get_update("Name", v5cID);
						var model = get_update("Place", v5cID);
						var reg = get_update("Date", v5cID);
						var colour = get_update("Party", v5cID);
						var carDetails = '['+vin+'] '+make+' '+model+', '+reg+', '+colour
						//272
						if(carDetails.indexOf('undefined') != -1)
						{
							carDetails = 'Vote Template' 
						}
					...
					if(type == "Create")
					{
						$('<tr class="retrievedRw" ><td class="smlBrk"></td><td style="width:1%; white-space:nowrap" class="transRw">['+v5cID+'] </td><td class="transRw" style="width:1%; white-space:nowrap"><span class="type" >Create</span><span class="message">: '+caller+'</span></td><td colspan="2" class="transRw">Create Vote Template</td><td class="transRw txtRight">'+timestamp+'</td><td class="smlBrk"></td></tr>').insertAfter('#insAft')
					}
					if(type == "Update")
					{
						var prev = get_update(update_type.toLowerCase(), v5cID);
						$('<tr class="retrievedRw " ><td class="smlBrk"></td><td style="width:1%; white-space:nowrap" class="transRw">['+v5cID+'] </td><td class="transRw" style="width:1%; white-space:nowrap"><span class="type" >Update</span><span class="message">: '+caller+'</span></td><td colspan="2" class="transRw">Updated: '+update_type+'</td><td class="transRw txtRight">'+timestamp+'</td><td class="smlBrk"></td></tr>').insertAfter('#insAft')			//: '+prev+' &rarr; '+arguments+'
					}
					if(type == "Scrap")
					{
						$('<tr class="retrievedRw" ><td class="smlBrk"></td><td style="width:1%; white-space:nowrap" class="transRw">['+v5cID+'] </td><td class="transRw" style="width:1%; white-space:nowrap"><span class="type" >Scrap</span><span class="message">: '+caller+'</span></td><td colspan="2" class="transRw">Scrap Vote Template</td><td class="transRw txtRight">'+timestamp+'</td><td class="smlBrk"></td></tr>').insertAfter('#insAft')
					}	
					if(failed)
					{
